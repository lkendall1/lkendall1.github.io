...
str(df)
```
The data has 5 columns and 30869 rows, as seen in the first line of the data summary above. 
...
```{r}
df2 <- df[(df$State=='Rhode Island')& (df$Date>'2020-12-31'),]
...
```{r}
df3 <- df2[(df2$Date >= '2021-06-01')&(df2$Date < '2021-10-01'),]
df3$Month <- format(df3$Date,"%B")
